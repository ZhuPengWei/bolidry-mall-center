package org.bolidry.mall.generator;
...
public class CodeGenerator {
    ...
    private final static String author = "ZhuPengWei";
     ...
     * 模块包名
     */
    private final static String module = "org.bolidry.mall";

    /**
     * 数据库链接配置
     */
    private final static String jdbcUrl = "jdbc:mysql://localhost:3306/bolidry_mall_address?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";
    private final static String jdbcUserName = "root";
    private final static String jdbcPwd = "zpwzpwzpw";
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/bolidry-mall-generator";
